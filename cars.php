...
if (isset($_GET['type'])) {
    ...
    $query = "SELECT * FROM car_listings WHERE CONCAT(',', category, ',') LIKE CONCAT('%,', '" . $id . "', ',%')";
...
elseif (isset($_GET['brand'])) {
    ...
    $query = "SELECT * FROM car_listings WHERE car_brand LIKE '%" . $brand . "%'";
...
$query = "SELECT * FROM car_listings WHERE CONCAT(',', category, ',') REGEXP CONCAT('(^|,)(', '" . $categoryFilter . "', ')(,|$)')";
    ...
    if ($brand && $model) {
        ...
        $query = "SELECT * FROM car_listings WHERE car_brand = '$brand' AND car_model = '$model'";
    } elseif ($brand) {
        // Only brand selected
        $query = "SELECT * FROM car_listings WHERE car_brand = '$brand'";
    } elseif ($model) {
        // Only model selected
        $query = "SELECT * FROM car_listings WHERE car_model = '$model'";
    }
    ...
    $query = "SELECT * FROM car_listings WHERE make_year = '$selectedYear'";
    ...
    if ($maxPrice !== false && $minPrice !== false) {
        ...
        $query = "SELECT * FROM car_listings WHERE price_per_day BETWEEN ? AND ?";
    ...
    $query = "SELECT * FROM car_listings WHERE CONCAT(',', car_features, ',') REGEXP CONCAT('(^|,)(', '" . $featuresFilter . "', ')(,|$)')";
    $getdata = mysqli_query($conn, $query);
}
    ...
    $query = "SELECT * FROM car_listings WHERE fuel_type = '$selectedFuel'";
    ...
    $query = "SELECT * FROM car_listings WHERE transmission = '$transmissionType'";
  ...
  $search = $_POST["search"];
  $getdata = mysqli_query($conn, "SELECT * FROM car_listings WHERE car_brand LIKE '%$search%' OR car_model LIKE '%$search%' OR make_year LIKE '%$search%';");
     ...
     $start =($page -1) * $Limit;
  $getdata = mysqli_query($conn, "SELECT * FROM `car_listings`  ORDER BY  sno DESC LIMIT $start, $Limit");
  
  $getdata1 = $conn->query( "SELECT count(sno) AS sno FROM `car_listings`  ORDER BY  sno DESC ");
  ...
  <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
   <!-- Google API -->
    ...
    .custom-carousel-item {
        flex: 0 0 50%; /* Show two items per slide */
        margin:10px;
        height:150px;
        border-radius:50px;
        width:200px;
        ...
        if (!empty($picNamesArray)) {
            ...
            ?>
                                <div class="col-xl-4 col-lg-6">
                                    <a href="car-single.php?deletid=<?php echo $id; ?>" style="color: unset; text-decoration: unset;"><div class="de-item mb30">
                                        <div class="d-img">
                            ...
                            ?>
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img src="/dist/php/car_listing_pics/<?php echo $row['feature_image']; ?>" class="d-block w-100" alt="...">
                                                </div>
                                               <?php
                            ...
                            ?>
                                <div class="carousel-item ">
                                    <img src="/dist/php/car_listing_pics/<?php echo $picNamesArray[$i]; ?>" class="d-block w-100" alt="...">
                                </div>
                            <?php
                            }
                            ?>
